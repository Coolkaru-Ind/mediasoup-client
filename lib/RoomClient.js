...
export default class RoomClient {
	...
	async _joinRoom() {
		...
		client.on('message', function (topic, message) {
			...
			let messageToChar = {
				thermometer: mqttMessage.temperature,
				oxymeter: mqttMessage.oxidation_level
			...
			let objToAPI = {
					...
					readings: {
						thermometer: mqttMessage.temperature.toString(),
						oxymeter: mqttMessage.oxidation_level.toString()
					},
